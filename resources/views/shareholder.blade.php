...
<div class="content-wrapper">
    ...
    <!-- /.content-header -->
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12">
          <a href="{{ route('admin.shareholdercreate')}}" class="btn btn-primary mb-3 text-left">Add Report</a>
            <div class="card">
                              ...
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  <div style="text-align: center;">
                                    <iframe src="{{ asset('storage/doc-shareholder/'.$d->file)}}" style="width:100%; height:600px;" frameborder="0"></iframe>
                                  </div>
                                </div>
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                ...
                                <form action="{{ route('admin.shareholderdelete',['id'=>$d->id]) }}" method="POST">
                                  @csrf
                                  @method('DELETE')
                                  <div class="modal-footer justify-content-between">
                                  <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
