...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Weekly Safety Report</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
    <!-- /.content-header -->
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12">
          <a href="{{ route('admin.weeklysafetycreate')}}" class="btn btn-primary mb-3 text-left">Add Report</a>
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">List Weekly safety Report</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                              ...
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  <div style="text-align: center;">
                                    <iframe src="{{ asset('storage/doc-weeklysafety/'.$d->file)}}" style="width:100%; height:600px;" frameborder="0"></iframe>
                                  </div>
                                </div>
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                ...
                                <form action="{{ route('admin.weeklysafetydelete',['id'=>$d->id]) }}" method="POST">
                                  @csrf
                                  @method('DELETE')
                                  <div class="modal-footer justify-content-between">
                                  <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
